...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/mundus/base/esp/esp32_cam_surv_ai/server/analysis/inference/build/flatbuffers'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/mundus/base/esp/esp32_cam_surv_ai/server/analysis/inference/build/flatbuffers'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
