...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "ef634603954d88d2643d5809011288b890ac126e"
  WORKING_DIRECTORY "/home/mundus/base/esp/esp32_cam_surv_ai/server/analysis/inference/build/cpuinfo"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/mundus/base/esp/esp32_cam_surv_ai/server/analysis/inference/build/cpuinfo'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/mundus/base/esp/esp32_cam_surv_ai/server/analysis/inference/build/cpuinfo'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
