...
#define TL_AGENT_INPUT_CHANNEL_RED_STANDARDIZATION__MEAN 0.485
#define TL_AGENT_INPUT_CHANNEL_RED_STANDARDIZATION__STDEV 0.229
#define TL_AGENT_INPUT_CHANNEL_GREEN_STANDARDIZATION__MEAN 0.456
#define TL_AGENT_INPUT_CHANNEL_GREEN_STANDARDIZATION__STDEV 0.224
#define TL_AGENT_INPUT_CHANNEL_BLUE_STANDARDIZATION__MEAN 0.406
#define TL_AGENT_INPUT_CHANNEL_BLUE_STANDARDIZATION__STDEV 0.225
